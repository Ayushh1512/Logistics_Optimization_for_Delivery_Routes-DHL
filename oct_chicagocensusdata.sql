...
--
-- Table structure for table `chicagocensusdata`
--
...
CREATE TABLE `chicagocensusdata` (
  ...
  `PERCENT_OF_HOUSING_CROWDED` double DEFAULT NULL,
  `PERCENT_HOUSEHOLDS_BELOW_POVERTY` double DEFAULT NULL,
  `PERCENT_AGED_16__UNEMPLOYED` double DEFAULT NULL,
  `PERCENT_AGED_25__WITHOUT_HIGH_SCHOOL_DIPLOMA` double DEFAULT NULL,
  `PERCENT_AGED_UNDER_18_OR_OVER_64` double DEFAULT NULL,
